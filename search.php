...
<body>
  ...
  <div id="content">
    ...
    $pstm = $conn->prepare("SELECT * FROM sach join theloai on sach.idtl = theloai.idtl WHERE tensach LIKE :keyword OR tentl Like :keyword");
    $pstm->execute(array('keyword' => '%' . $keyword . '%'));
    $data = $pstm->fetchAll(PDO::FETCH_ASSOC);
    foreach ($data as $item) {
    ?>
      <div class="book">
        ...
        <div class="click-item">
          <div class="click-a"><a href="">Xem chi tiết</a></div>
